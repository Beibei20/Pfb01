...
#define  DHT11_BUS_HIGH     (DHT11_GPIO->BSRR = (uint32_t)DHT11_PIN)           // DAT引脚 置高电平
#define  DHT11_BUS_LOW      (DHT11_GPIO->BSRR = ((uint32_t)DHT11_PIN) << 16)   // DAT引脚 置低电平
#define  DHT11_BUS_READ     ((DHT11_GPIO->IDR & DHT11_PIN) ? 1: 0)             // 读取引脚的电平
